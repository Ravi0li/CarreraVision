...
private:
	...
	static const int stepX = 300;		// Um wie viel sollen die Fenster nach X versetzt sein
	static const int stepY = 400;		// Um wie viel sollen die Fenster nach Y versetzt sein
	static const int maxEveryRow = 6;   // Wie viele Fenster dürfen maximal nebeneinander sein
